...
function EditVisitPage() {
  ...
  useEffect(() => {
    ...
    async function loadVisit() {
      ...
      setRegionCode(visit.region_code)
      setStartedOn(visit.started_on ?? '')
      setEndedOn(visit.ended_on ?? '')
  ...
  async function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    if (!user || !visitId) {
      setErrorMessage('방문 기록 정보를 확인할 수 없습니다.')
      return
    }
            ...
            >
              ...
              <div className="mt-6 flex flex-col-reverse gap-3 sm:flex-row sm:justify-end">
                ...
                <button
                  ...
                  disabled={isSubmitting || isLoadingRegions || isLoadingVisit}
                  type="submit"
                >
